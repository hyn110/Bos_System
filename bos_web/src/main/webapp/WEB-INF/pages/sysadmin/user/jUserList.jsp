...
<ul>
<li deptId="view"><a href="javascript:toView()">查看</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('userAction_tocreate','_self');this.blur();">新增</a></li>
<li deptId="update"><a href="#" onclick="javascript:toUpdate()">修改</a></li>
<li deptId="update"><a href="#" onclick="formSubmit('userAction_torole','_self');this.blur();">角色</a></li>
<li deptId="delete"><a href="#" onclick="formSubmit('userAction_delete','_self');this.blur();">删除</a></li>
</ul>
  </div>
</div>
</div>
...
${links}
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td><a href="userAction_toview?deptId=${o.deptId}">${o.userName}</a></td>
		<td>${o.state }</td>
	</tr>
	</c:forEach>
