...
<body deptId="left_frame">
<div class="PositionFrame_black" deptId="PositionFrame"></div>
 
 
<div deptId="sidebar" class="sidebar">
	<div class="sidebar_t">
	   ...
	   <div class="panel">
	       ...
	       <div class="panel-header">
	        ...
	        <div class="panel-content">
				<ul>
					<li><a href="${ctx}/tomain.action?modelName=home" target="main" deptId="aa_3" onclick="linkHighlighted(this)">我的留言板</a></li>
					<li><a href="${ctx}/home/workflow/tasklist.action" target="main" deptId="aa_2" onclick="linkHighlighted(this)">我的代办任务</a></li>
					<li><a href="${ctx}/baseinfo/leavebill/list.action" target="main" deptId="aa_1" onclick="linkHighlighted(this)">意见反馈</a></li>
				</ul>
	        </div>
...
<div deptId="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-content">
			<ul>
				<li><a href="#" deptId="aa_2" onclick="linkHighlighted(this)">个人信息修改</a></li>
				<li><a href="#" deptId="aa_2" onclick="linkHighlighted(this)">系统使用反馈</a></li>
			</ul>
        </div>
    </div>
    </div>
