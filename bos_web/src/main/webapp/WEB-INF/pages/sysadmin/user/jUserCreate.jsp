...
<ul>
<li deptId="save"><a href="#" onclick="formSubmit('userAction_insert','_self');this.blur();">保存</a></li>
		...
		<table class="commonTable" cellspacing="1">
       		<tr>
	            ...
	            <td class="tableContent">
	            	<s:select name="dept.deptId" list="deptList"
        	...
        	<tr>
	            ...
	            <td class="tableContent">
	            	<s:select name="userInfo.manager.deptId" list="userList"
	            		listKey="deptId" listValue="userInfo.name"
	            		headerKey="" headerValue="--请选择--"
	            	></s:select>
	            </td>
	        </tr>		
