	...
	<div class="box">
			<div class="inputstyle">
				<div class="inputlable">用户名：
					<input type="text" value="${userName}" name="username" deptId="userName" onFocus="this.select();" title="请您输入用户名"/>
					<div deptId="ts" style="z-index:1;">
					</div>
				</div>

			    <div class="inputlable">密　码：
					<input type="password" value="${password}" name="password" deptId="password" onfocus="$('#ts').css('display','none');this.select();"
