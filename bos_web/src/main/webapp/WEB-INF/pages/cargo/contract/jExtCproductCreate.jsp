...
<form name="icform" method="post">
	<input type="hidden" name="contractProduct.contract.deptId" value="${contractProduct.contract.deptId}"/>
	<input type="hidden" name="contractProduct.deptId" value="${contractProduct.deptId}"/>
...
<ul>
<li deptId="save"><a href="#" onclick="formSubmit('extCproductAction_insert','_self');this.blur();">保存</a></li>
...
<table deptId="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.amount}</td>
		<td>
			<a href="extCproductAction_toupdate.action?deptId=${o.deptId}">[修改]</a>
			<a href="extCproductAction_delete.action?deptId=${o.deptId}&contractProduct.deptId=${o.contractProduct.deptId}&contractProduct.contract.deptId=${contractProduct.contract.deptId}">[删除]</a>
		</td>
	</tr>
	</c:forEach>
