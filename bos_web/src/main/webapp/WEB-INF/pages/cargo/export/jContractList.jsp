...
<ul>
<li deptId="view"><a href="#" onclick="formSubmit('${ctx}/cargo/contractAction_toview','_self');this.blur();">查看</a></li>
<li deptId="print"><a href="#" onclick="formSubmit('${ctx}/cargo/contractAction_print','_self');this.blur();">打印</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('${ctx}/cargo/exportAction_tocreate','_self');this.blur();">报运</a></li>
</ul>
  </div>
</div>
</div>
...
<table deptId="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.customName}</td>
		<td>
			<a href="contractAction_toview?deptId=${o.deptId}">${o.contractNo}</a>
		</td>
		<td align="center">
