...
<form deptId="orderform" name="orderform" action="${ctx}/flow/orderFlowAction_addOrderSubmit.action" method="post">
						...
						<TBODY>
							...
							<tr>
							  <td colspan=4 align=center class=category>
								<a deptId="submitbtn"  class="easyui-linkbutton"   iconCls="icon-ok" href="#" onclick="ordersave()">提交</a>
								<a deptId="closebtn"  class="easyui-linkbutton" iconCls="icon-cancel" href="#" onclick="parent.closemodalwindow()">关闭</a>
							  </td>
							</tr>
