...
<form name="icform" method="post">
	<input type="hidden" name="contract.deptId" value="${contract.deptId}"/>
...
<ul>
<li deptId="save"><a href="#" onclick="formSubmit('contractProductAction_insert','_self');this.blur();">保存</a></li>
...
<table deptId="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.amount}</td>
		<td>
			<a href="contractProductAction_toupdate.action?deptId=${o.deptId}">[修改]</a>
			<a href="contractProductAction_delete.action?deptId=${o.deptId}&contract.deptId=${o.contract.deptId}">[删除]</a>
			<a href="extCproductAction_tocreate.action?contractProduct.contract.deptId=${o.contract.deptId}&contractProduct.deptId=${o.deptId}">[附件]</a>
		</td>
	</tr>
