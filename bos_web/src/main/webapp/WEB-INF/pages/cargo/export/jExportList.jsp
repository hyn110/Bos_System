...
<ul>
<li deptId="view"><a href="#" onclick="formSubmit('exportAction_toview','_self');this.blur();">查看</a></li>
<li deptId="update"><a href="#" onclick="formSubmit('exportAction_toupdate','_self');this.blur();">修改</a></li>
<li deptId="delete"><a href="#" onclick="formSubmit('exportAction_delete','_self');this.blur();">删除</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('exportAction_submit','_self');this.blur();">提交</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('exportAction_cancel','_self');this.blur();">取消</a></li>
</ul>
  </div>
</div>
</div>
