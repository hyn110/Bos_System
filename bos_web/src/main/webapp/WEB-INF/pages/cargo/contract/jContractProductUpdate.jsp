...
<ul>
<li deptId="save"><a href="#" onclick="formSubmit('contractProductAction_update','_self');this.blur();">保存</a></li>
		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent">
	            	...
	            	<input type="hidden" deptId="factoryName" name="factoryName" value="${factoryName }"/>
	            </td>
