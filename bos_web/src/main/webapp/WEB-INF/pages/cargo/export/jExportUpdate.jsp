...
<script language="JavaScript">
	...
	function addTRRecord(objId, deptId, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
		...
		oTD.innerHTML = "<input class=\"input\" type=\"checkbox\" name=\"del\" value=\""+deptId+"\"><input type=\"hidden\" name=\"mr_id\" value=\""+deptId+"\"><input class=\"input\" type=\"hidden\" deptId=\"mr_changed\" name=\"mr_changed\">";
...
<ul>
<li deptId="save"><a href="#" onclick="formSubmit('exportAction_update','_self');this.blur();">保存</a></li>
  ...
  <div class="textbox-title">
   ...
   修改出口报运
	...
	<div class="listTablew">
		<table class="commonTable_main" cellSpacing="1" deptId="mRecordTable">
