...
<ul>
<li deptId="view"><a href="#" onclick="formSubmit('contractAction_toview','_self');this.blur();">查看</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('contractAction_tocreate','_self');this.blur();">新增</a></li>
<li deptId="update"><a href="#" onclick="formSubmit('contractAction_toupdate','_self');this.blur();">修改</a></li>
<li deptId="delete"><a href="#" onclick="formSubmit('contractAction_delete','_self');this.blur();">删除</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('contractAction_submit','_self');this.blur();">提交</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('contractAction_cancel','_self');this.blur();">取消</a></li>
<li deptId="new"><a href="#" onclick="formSubmit('contractAction_print','_self');this.blur();">打印</a></li>
</ul>
  </div>
</div>
</div>
...
<table deptId="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.customName}</td>
		<td><a href="contractAction_toview?deptId=${o.deptId}">${o.contractNo}</a></td>
		<td>
		...
		<td><a href="${ctx }/cargo/contractProductAction_tocreate?contract.deptId=${o.deptId}">[货物]</a></td>
	</tr>
	</c:forEach>
