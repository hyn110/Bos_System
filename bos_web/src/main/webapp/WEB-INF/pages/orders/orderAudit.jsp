...
<form deptId="oorderAuditForm" name="oorderAuditForm" action="${ctx}/flow/orderFlowAction_submitOrderAudit.action" method="post">
						...
						<TBODY>
							...
							<tr>
							  <td colspan=4 align=center class=category>
								<a deptId="submitbtn"  class="easyui-linkbutton"   iconCls="icon-ok" href="#" onclick="orderAudit()">提交</a>
							  </td>
							</tr>
