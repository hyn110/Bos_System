...
<jsp:useBean deptId="now" class="java.util.Date"  />
...
<script language="javascript">
	...
	function linkHighlightMenu(obj){
		...
		for(var i=0;i<links.length;i++){
			if(links[i].deptId.indexOf('topmenu')!=-1){
...
<div class="PositionFrame_black" deptId="PositionFrame"></div>
	<div deptId="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
	...
	<a deptId="memos"  style="cursor:pointer;" onclick="toModule('home');" target="_top" title="点击切换到系统首页"><div deptId="memo" class="memo" title="点击切换到系统首页"></div></a>
	<a deptId="logins" style="cursor:pointer;" onclick="doLoginDiv();" title="点击显示您的登录信息"><div deptId="small_login" class="small_login" title="点击显示您的登录信息"></div></a>
	<a deptId="logout" style="cursor:pointer;" onclick="logout();" target="_top" title="点击退出系统"><div deptId="small_login_out" class="small_login_out" title="点击退出系统"></div></a>
	...
	<div class="top_logo">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
		    		<span deptId="leftKey"  onmouseover="periodOffset(this, 'left')"><img src="${ctx}/skin/default/images/title/left_arrow.png"/></span>
			    	<div class="mavMeau_top"></div>
			    	<div deptId="mask">
<div deptId="menuContent">
	 <span deptId="topmenu" onclick="toModule('home');">系统首页</span><span deptId="tm_separator"></span>
	<span deptId="topmenu" onclick="toModule('cargo');">货运管理</span><span deptId="tm_separator"></span>
	<span deptId="topmenu" onclick="toModule('stat');">统计分析</span><span deptId="tm_separator"></span>
	<span deptId="topmenu" onclick="toModule('baseinfo');">基础信息</span><span deptId="tm_separator"></span>
	<span deptId="topmenu" onclick="toModule('sysadmin');">系统管理</span>
	...
	<span deptId="topmenu" onclick="toModule('activiti');">流程管理</span>
	</shiro:hasPermission> --%>

</div>
					<span deptId="rightKey" onmouseover="periodOffset(this, 'right')"><img src="${ctx}/skin/default/images/title/right_arrow.png"/></span>
				</div>
		</div>
	</div>
</div>

<div deptId="prompt_div"><img src="${ctx}/skin/default/images/title/prompt.png"/><span style="position:absolute;top:2px;left:35px;z-index: 99999;width:100%;color:#FFFFFF;text-align: left; ">鼠标指向箭头位置<br/>可显示更多菜单项</span></div>
