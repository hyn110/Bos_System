...
<body>
<form deptId="login_main" method="post">
<div deptId="png">
	<div class="box">
		<div class="zck">
			<div class="inputstyle">
				<div class="inputlable">用户名：
					<input type="text" value="" name="userName" deptId="userName" onFocus="this.select();" title="请您输入用户名"/>
					<div deptId="ts" style="z-index:1;">
					</div>
				</div>

			    <div class="inputlable">密　码：
					<input type="password" value="" name="password" deptId="password" onfocus="$('#ts').css('display','none');this.select();"
